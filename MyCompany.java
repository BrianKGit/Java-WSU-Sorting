...
public class MyCompany
{
    public static void main(String[] args) throws FileNotFoundException
    {
        ...
        Scanner inFile = new Scanner(new FileReader("employee_data.txt"));
      ...
      while(flag) {
		    ...
		    displayMenu();
             ...
             case 3:  
					  ...
					  EmployeeInfo searched = new EmployeeInfo( 0, "Danny", "Clark", 0.0);
                 
                 int foundIndex = SearchingMethods.binarySearch( all, searched, 0, all.length-1);
                 
                 if(foundIndex == -1)
                    System.out.println("Not Found.");
                 else
                    System.out.println("Found: " + all[foundIndex]);
